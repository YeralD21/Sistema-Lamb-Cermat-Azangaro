            ...
            <tbody class="divide-y divide-slate-50">
              <tr *ngFor="let c of concepts" class="group hover:bg-slate-50/50 transition-colors">
                ...
                <td class="py-5 px-6 text-center">
                  <span class="text-sm font-bold text-slate-900 tracking-tight">S/ {{ c.amount | number:'1.2-2' }}</span>
                </td>
                <td class="py-5 px-6">
                ...
                <td class="py-5 px-8 text-right">
                  <div class="flex items-center justify-end gap-2">
                    <button class="p-2 text-slate-400 hover:text-blue-900 transition-colors">
...
export class FinanceConceptsComponent {
  kpis = [
    { label: 'Total', value: 1, iconColor: 'text-blue-500', icon: '<path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/>' },
    { label: 'Activos', value: 1, iconColor: 'text-green-500', icon: '<path d="m9 11 3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>' },
    { label: 'Pensiones', value: 1, iconColor: 'text-purple-500', icon: '<rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/><path d="M16 18h.01"/>' },
    { label: 'Matrículas', value: 0, iconColor: 'text-orange-500', icon: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M10 13h4"/><path d="M10 17h4"/>' },
  ];

  concepts = [
    { name: 'pension 2025', type: 'Pensión', amount: 100, periodicity: 'Mensual', status: 'Activo' }
  ];
}
